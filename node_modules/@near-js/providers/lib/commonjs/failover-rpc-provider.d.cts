...
declare class FailoverRpcProvider implements Provider {
    ...
    callFunction<T extends SerializedReturnValue>(accountId: string, method: string, args: Record<string, unknown>, blockQuery?: BlockReference): Promise<T | undefined>;
    ...
    viewValidatorsV2(params: {
        blockId: string | number;
    } | {
        epochId: string;
    } | null): Promise<EpochValidatorInfo>;
