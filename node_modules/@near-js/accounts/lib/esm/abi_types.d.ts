 ...
 */
type SingleOrVecFor_Schema = Schema | Schema[];
/**
 * A type which can be serialized as a single item, or multiple items.
 *
 * In some contexts, a `Single` may be semantically distinct from a `Vec` containing only item.
 */
type SingleOrVecFor_InstanceType = InstanceType | InstanceType[];
/**
 ...
 */
type InstanceType = "null" | "boolean" | "object" | "array" | "number" | "string" | "integer";
/**
 ...
 */
type AbiFunctionKind = "view" | "call";
/**
 * Function can have multiple modifiers that can change its semantics.
 */
type AbiFunctionModifier = "init" | "private" | "payable";
/**
...
export type { AbiBody, AbiBorshParameter, AbiFunction, AbiFunctionKind, AbiFunctionModifier, AbiJsonParameter, AbiMetadata, AbiParameters, AbiRoot, AbiType, BuildInfo, InstanceType, RootSchema, Schema, SchemaObject, SingleOrVecFor_InstanceType, SingleOrVecFor_Schema };
